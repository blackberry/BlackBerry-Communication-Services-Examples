...
import com.bbm.sdk.support.ui.widgets.chats.holders.BaseOutgoingBubbleHolder;
import com.bbm.sdk.support.ui.widgets.recycler.RecyclerViewHolder;


/**
 * The outgoing text holder. This extends the BaseOutgoingBubbleHolder to show the chat message.
 */
public class OutgoingTextHolder extends BaseOutgoingBubbleHolder implements RecyclerViewHolder<DecoratedMessage> {

    private TextView mMessageBody;

    public OutgoingTextHolder(LayoutInflater layoutInflater, ViewGroup parent) {
    ...
    public void updateView(DecoratedMessage decoratedMessage, int position) {
        ...
        if (decoratedMessage.getChatMessage() != null) {
