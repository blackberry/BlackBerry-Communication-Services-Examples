...
/**
 * The incoming text holder. This extends the BaseIncomingBubbleHolder to show the chat message.
 */
public class IncomingTextHolder extends BaseIncomingBubbleHolder implements RecyclerViewHolder<DecoratedMessage> {

    private TextView mMessageBody;

    public IncomingTextHolder(LayoutInflater layoutInflater, ViewGroup parent) {
