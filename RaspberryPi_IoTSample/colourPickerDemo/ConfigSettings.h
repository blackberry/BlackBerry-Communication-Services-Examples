...
//
#define SDK_SERVICE_DOMAIN @"your_domain"


//
//  PERIPHERAL_REG_ID must be changed to the Reg ID of the user that is logged
//  into your peripheral device.
//

#define PERIPHERAL_REG_ID @"your_peripheral_device_reg_id"
