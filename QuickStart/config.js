...
// The environment of your BBM Enterprise server. Must be either "Sandbox" or "Production".
var ID_PROVIDER_ENVIRONMENT = "Sandbox";

// This configuration contains service endpoints and information for OAuth2 authentication.
var AUTH_CONFIGURATION = {
  ...
  // To use google OAuth service, put : "https://accounts.google.com/o/oauth2/v2/auth"
  authService : "your_auth_service_endpoint",

  // OAuth 2.0 endpoint for token validation
  // To use google token info service, put : "https://www.googleapis.com/oauth2/v3/tokeninfo"
  tokenInfoService : "your_oauth_token_info_endpoint",

  // OAuth 2.0 endpoint for obtaining user information (name, email, avatar URL)
  // To use google user info service, put: "https://www.googleapis.com/plus/v1/people/me"
