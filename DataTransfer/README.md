...
# BBM Enterprise SDK Data Transfer Sample
...
the BBM Enterprise SDK. This example builds on the [Quick Start](../QuickStart/README.md) example that
...
[Data Transfer page in the BBM Enterprise SDK Guide](https://developer.blackberry.com/files/bbm-enterprise/documents/guide/html/examples/android/DataTransfer/README.html).
In particular, to use this example you must complete the steps in the [prerequisites](https://developer.blackberry.com/files/bbm-enterprise/documents/guide/html/examples/android/DataTransfer/README.html#prereq) section.
